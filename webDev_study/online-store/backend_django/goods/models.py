...
class GoodsCategory(models.Model):
    ...
    code = models.CharField(default="", max_length=30, verbose_name="类别code", help_text="类别code")  # 类编码
    ...
    parent_category = models.ForeignKey("self", null=True, blank=True, verbose_name="父目录级别", help_text="父目录", related_name="sub_cat",
